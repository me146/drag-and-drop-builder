                                  ...
                                  return (
                                    ...
                                    >
                                      <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" onClick={() => handleDelete(item, index, column.name)} className={styles.icon} strokeWidth={1} stroke="currentColor">
